...
public class WaypointSystem : MonoBehaviour
    {
        ...
        [SerializeField] private ProgressStyle progressStyle = ProgressStyle.PointToPoint;
        ...
        private void Start()
        {
            ...
            circuit = GameObject.Find("WaypointsCircuit").GetComponent<WaypointCircuit>();
		...
		{
			Debug.Log(other.tag + "   " + currentLap);
			if(other.tag == "checkpoint"){
                if (currentLap == GameInfo.Laps) {
                    endedRace = true;
                    return;
                }
				currentLap++;
